...
Загружает входные файлы из каталога input/, вызывает парсер и генераторы,
записывает четыре выходных артефакта в каталог out/ и проверяет,
что результат применения дельты совпадает с patched_config.json.
"""
import json
